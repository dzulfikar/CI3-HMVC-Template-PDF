...
$path = "../application/modules/".$table."/controllers/" . $controller_file;
$dirpath = "../application/modules/".$table."/controllers/";
...
/* Location: ./application/modules/$controller/controllers/$controller_file */";
